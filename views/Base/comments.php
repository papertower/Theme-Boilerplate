...
<?php // You can start editing here. ?>
  ...
  <?php if ( have_comments() ) : ?>
    ...
    <h3 id="comments-title" class="h2"><?php comments_number( __( '<span>No</span> Comments', 'theme' ), __( '<span>One</span> Comment', 'theme' ), _n( '<span>%</span> Comments', '<span>%</span> Comments', get_comments_number(), 'theme' ) );?></h3>
