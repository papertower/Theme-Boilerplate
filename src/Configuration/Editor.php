...
class Editor implements Registerable {
  ...
  public function set_first_row_tiny_mce_buttons($mce_buttons, $editor_id) {
    if ( 'content' !== $editor_id ) return $mce_buttons;
    return array('formatselect', 'bold', 'italic', 'underline', 'blockquote', 'strikethrough', 'bullist', 'numlist', 'undo', 'redo', 'link', 'unlink', 'removeformat', 'fullscreen');
  }
  ...
  public function set_second_row_tiny_mce_buttons($mce_buttons, $editor_id) {
    return 'content' === $editor_id ? array() : $mce_buttons;
  }
