...
/**
 * A helper for easily getting state and country arrays and values
 */
class Geography {
  /**
   * Returns an array with the 50 US states wherein the key is the abbreviated state and the value
   * is the full state name
   *
  ...
  /**
   * Returns a single state full name
  ...
  /**
   * Returns an array with all the countries wherein the key is the abbreviated country and the
   * value is the full state name
   *
   * @return array<string> Array of countries
   */
  ...
  /**
   * Returns a single country full name
   * @param  string $country_code The abbreviated country code
